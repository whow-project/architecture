            ...
            with open(os.path.join(self._data_path, "tipo_affid.csv"), "r+", encoding="utf-8") as affidfile:
                ...
                for row in data:
                    ...
                    if ente_proponente.startswith("Comune - "):
                        ...
                        ente_proponente_type_uri = "https://dati.isprambiente.it/ontology/places/Municipality"
                        ...
                        if ente_proponente_id in metropolitan_cities:
                            ...
                            ente_proponente_type_uri = "https://dati.isprambiente.it/ontology/places/MetropolitanCity"
                        else:
                            ente_proponente_type = "province"
                            ente_proponente_type_uri = "https://dati.isprambiente.it/ontology/places/Province"
                    elif ente_proponente.startswith("Regione - "):
                    
                        ente_proponente_type = "region"
                        ente_proponente_type_uri = "https://dati.isprambiente.it/ontology/places/Region"
                    else:
                    ...
                    if ente_attuatore.startswith("Comune - "):
                        ...
                        ente_attuatore_type_uri = "https://dati.isprambiente.it/ontology/places/Municipality"
                        ...
                        if ente_attuatore_id in metropolitan_cities:
                            ...
                            ente_attuatore_type_uri = "https://dati.isprambiente.it/ontology/places/MetropolitanCity"
                        else:
                            ente_attuatore_type = "province"
                            ente_attuatore_type_uri = "https://dati.isprambiente.it/ontology/places/Province"
                    elif ente_attuatore.startswith("Regione - "):
                    
                        ente_attuatore_type = "region"
                        ente_attuatore_type_uri = "https://dati.isprambiente.it/ontology/places/Region"
                    else:
