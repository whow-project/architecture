...
def get_staz_subst_list(output_folder):
    ...
    for reg in regions:
        ...
        '''
        print ('Getting stat and subs list for', reg, '...')
        ...
        newcsvfile = os.path.join(output_folder, 'stat_subst_static_' + reg.strip() + '.csv')
